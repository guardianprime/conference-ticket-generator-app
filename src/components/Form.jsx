        ...
        <form onSubmit={handleSubmit} className="bg-indigo-950 min-h-screen max-h-max p-4 w-full">
            ...
            <div>
                ...
                <div className="flex items-center justify-center w-full my-2">
                    <label htmlFor="dropzone-file" className="flex flex-col items-center justify-center w-full h-30 border-2 border-white border-dashed rounded-lg cursor-pointer bg-indigo-950">
