    ...
    return (
        <form onSubmit={handleSubmit} className="bg-multi min-h-screen max-h-max p-4 w-full">
            ...
            <div className="mt-4">
                ...
                <input className="border border-neutral-300 p-2 my-2 w-full text-white rounded-lg bg-indigo-950" id="userName" name="userName" type="text" onChange={handleChange} />
            </div>
            <div>
                <label htmlFor="userEmail" className="text-white">Email Address</label>
                <input className="border border-neutral-300 p-2 my-2 w-full text-white rounded-lg bg-indigo-950" id="userEmail" name="userEmail" placeholder="example@email.com" type="email" onChange={handleChange} />
            </div>
            <div>
                <label htmlFor="userGithubName" className="text-white">GitHub Username</label>
                <input className="border border-neutral-300 p-2 my-2 w-full text-white rounded-lg bg-indigo-950" id="userGithubName" name="userGithubName" type="text" placeholder="@yourusername" onChange={handleChange} />
            </div>
